...
// AirDrop is a paid mutator transaction binding the contract method 0x045f7850.
//
// Solidity: function airDrop(address addr, uint256 amount) returns()
func (_Erc20 *Erc20Transactor) AirDrop(opts *bind.TransactOpts, addr common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Erc20.contract.Transact(opts, "airDrop", addr, amount)
}

// AirDrop is a paid mutator transaction binding the contract method 0x045f7850.
//
// Solidity: function airDrop(address addr, uint256 amount) returns()
func (_Erc20 *Erc20Session) AirDrop(addr common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.AirDrop(&_Erc20.TransactOpts, addr, amount)
}

// AirDrop is a paid mutator transaction binding the contract method 0x045f7850.
//
// Solidity: function airDrop(address addr, uint256 amount) returns()
func (_Erc20 *Erc20TransactorSession) AirDrop(addr common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.AirDrop(&_Erc20.TransactOpts, addr, amount)
}
